...
class Storage {
  ...
  /**
   * Получение значений ключений из хранилища.
   * Значение ключа, которого нет в хранилище получает значение null.
   * Возвращает объект значений.
   * */
  // take(listKeys) {
  //   const store = this._read();

  //   return Object.entries(store).reduce((accumulator, [key, value]) => {}, {});
  // }
